...
#find execution times for input task list
...
def get_inputs():
    ...
    #handle blank rows in python, convert to int, handle bad entries (regex)
    #alert js on missing values
    #convert arrays into list of Task objects
